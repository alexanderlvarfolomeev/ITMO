...
public class UserService {
    ...
    public void validateAdmin(User user) throws ValidationException {
        User userValid = find(user.getId());
        if (!userValid.isAdmin()) {
            throw new ValidationException("You don't have enough rights for this operation");
        }
    }
    ...
    public void changeAdmin(long userId, boolean admin) {
        userRepository.changeAdmin(userId, admin);
    }

    public void updateAdmin(User user) {
        User userActual = find(user.getId());
        user.setAdmin(userActual.isAdmin());
    }
}
